...
class AppThemeData {
  ...
  static final TextTheme _textTheme = TextTheme(
    headline1: GoogleFonts.manrope(fontWeight: _bold, fontSize: 26),
    headline2: GoogleFonts.manrope(fontWeight: _bold, fontSize: 22),
    headline3: GoogleFonts.manrope(fontWeight: _semiBold, fontSize: 16),
    headline4: GoogleFonts.manrope(fontWeight: _semiBold, fontSize: 14),
    headline5: GoogleFonts.manrope(fontWeight: _medium, fontSize: 14),
    headline6: GoogleFonts.manrope(fontWeight: _medium, fontSize: 12),
    bodyText1: GoogleFonts.manrope(fontWeight: _medium, fontSize: 16),
    bodyText2: GoogleFonts.manrope(fontWeight: _medium, fontSize: 14),
    button: GoogleFonts.manrope(fontWeight: _medium, fontSize: 16),
