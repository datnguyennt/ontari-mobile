...
import 'package:ontari_mobile/data/remote/provider/user.provider.dart' as _i6;
...
_i1.GetIt initGetIt(
  ...
  gh.lazySingleton<_i6.UserProvider>(
      () => _i6.UserProvider(dioClient: gh<_i4.DioHelper>()));
  gh.singleton<_i7.UserRepository>(_i7.UserRepository(gh<_i6.UserProvider>()));
  return getIt;
}
